...
if (is_array($pagemulticat))
{
	...
	{
		$page_form_mcategories .= '<div class="multicat">' . cot_selectbox_categories($pagemcat, 'pagemulticat[]') . '<input name="deloption" value="x" type="button" class="delcat" style="display:none;" />
</div>';
	}
}
