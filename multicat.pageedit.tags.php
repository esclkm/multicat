...
{
	$page_form_mcategories .= '<div class="multicat">' . cot_selectbox_structure('page', $pag_mc['mc_pagecat'], 'pagemulticat[]') . '<input name="deloption" value="x" type="button" class="delcat" style="display:none;" />
</div>';
}
